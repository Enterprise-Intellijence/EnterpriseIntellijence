...
public class AppSecurityConfig  {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http, AuthenticationManager authenticationManager) throws Exception {
        http.csrf().disable()
                ...
                .and()
                .authorizeHttpRequests().requestMatchers(HttpMethod.GET,"/api/v1/products/{id}","/api/v1/products/filter","/api/v1/images/users/photo-profile/{id}","/api/v1/images/product/{id}").permitAll()
                .and()
                .authorizeHttpRequests().requestMatchers("/api/v1/demo","/api/v1/users/register", "/api/v1/users/authenticate",
                        ...
                        "/api/v1/products","user_photos/**","/api/v1/images/**","/tempFileDemo/**","/api/v1/reviews/{userId}/received","/api/v1/reviews/{userId}/sent"
